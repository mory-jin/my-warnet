        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-4">
          ...
          <div className="fixed right-6 top-1/2 -translate-y-1/2 z-50 ">
              ...
              <div className="flex flex-col items-center gap-7">
                ...
                {/* Discord */}
                <a 
                  href="https://discord.gg/58kmgW4sW8" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="group relative"
                >
                  <div className="w-16 h-16 bg-gradient-to-br from-[#5865F2] via-[#4752C4] to-[#404EED] rounded-full flex items-center justify-center  transform transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-[#5865F2]/50 border border-[#5865F2]">

                    <svg
                      className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M20.317 4.369a19.791 19.791 0 00-4.885-1.515.074.074 0 00-.079.037c-.211.375-.444.864-.608 1.249a18.27 18.27 0 00-5.487 0 12.64 12.64 0 00-.617-1.249.077.077 0 00-.079-.037 19.736 19.736 0 00-4.885 1.515.07.07 0 00-.032.027C.533 9.045-.32 13.58.099 18.057a.082.082 0 00.031.056 19.9 19.9 0 006.012 3.03.077.077 0 00.084-.027c.462-.63.873-1.295 1.226-1.994a.076.076 0 00-.041-.106 13.201 13.201 0 01-1.872-.9.077.077 0 01-.008-.127c.126-.095.252-.194.372-.291a.074.074 0 01.077-.01c3.927 1.793 8.18 1.793 12.061 0a.073.073 0 01.078.009c.12.098.246.197.372.292a.077.077 0 01-.006.127 12.299 12.299 0 01-1.873.899.077.077 0 00-.04.107c.36.698.772 1.364 1.225 1.994a.076.076 0 00.084.028 19.86 19.86 0 006.012-3.03.077.077 0 00.032-.055c.5-5.177-.838-9.673-3.548-13.66a.061.061 0 00-.031-.028zM8.02 15.331c-1.183 0-2.156-1.085-2.156-2.419 0-1.333.955-2.418 2.157-2.418 1.21 0 2.175 1.095 2.156 2.418 0 1.334-.955 2.419-2.156 2.419zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.418 2.157-2.418 1.21 0 2.175 1.095 2.156 2.418 0 1.334-.946 2.419-2.156 2.419z"/>
                    </svg>
